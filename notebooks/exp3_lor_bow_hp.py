...
MLFLOW_TRACKING_URI = "https://dagshub.com/mohanakshaykannur/ml-ops-complete-project.mlflow"
dagshub.init(repo_owner="mohanakshaykannur", repo_name="ml-ops-complete-project", mlflow=True)
